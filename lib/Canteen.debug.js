    ...
    Forms.FEEDBACK_SUCCESS = "formSuccess", Forms.destroy = function() {
        ...
        if ($("input." + Forms.CONFIRM + ", button." + Forms.CONFIRM).untouch().touch(function(e) {
            ...
            var showRequest = function(formData, form) {
                ...
                return -1 == response.search(/^{.*}$/) ? (Debug.error(response), void 0) : (response = JSON.parse(response), 
                "fatalError" == response.type ? (Debug.fatalError(response), void 0) : response.redirect ? (site.redirect(response.redirect, !1, !0), 
                void 0) : (Debug.log(response.messages.join("\n")), response.ifError || "true" != form.refresh.value ? (Forms.formFeedback(form, response.messages, response.ifError), 
                void 0) : (site.refresh(), void 0)));
            }, options = {
                data: {
                    async: !0
                },
